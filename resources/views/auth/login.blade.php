...
<head>
	...
	<title>Login | Sistem Informasi Absensi P3K & PPLSP</title>
...
<body class="login">
	<div class="wrapper wrapper-login" style="background-image: url(assets/img/login3.jpg); background-repeat: no-repeat; background-size: cover; background-position:center;">
		<div class="container container-login animated fadeIn">
			<div class="row">
{{--				<div class="col-sm-3"></div>--}}
{{--				<div class="col-sm-6">--}}
					<img src="{{ asset('/assets/img/logo.png') }}" style="width: 100px; height: 100px; margin: auto;" class="img-fluid">
{{--				</div>--}}
{{--				<div class="col-sm-3"></div>--}}
			</div>
