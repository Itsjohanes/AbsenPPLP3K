...
@section('title', 'Absensi Guru PPLSP')
    ...
    <div class="content">
        <div class="page-inner">
            <div class="page-header">
                <h4 class="page-title">Absensi Guru PPLSP</h4>
                ...
                <div class="col-md-3 pl-md-0">
                    <div class="card card-success card-annoucement card-round">
                        <div class="card-body text-center">
                            ...
                            <div class="card-detail">
                                <form action="{{ route('absen-guru-ppl.store') }}" method="POST">
                                    @csrf
                ...
                <div class="col-md-3 pl-md-0">
                    <div class="card card-danger card-annoucement card-round">
                        <div class="card-body text-center">
                            ...
                            <div class="card-detail">
                                <form action="{{ route('absen-ppl-keluar') }}" method="POST">
                                    @csrf
