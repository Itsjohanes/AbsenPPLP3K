...
@section('title', 'Laporan Absensi Guru P3K')
    ...
    <div class="content">
        <div class="page-inner">
            <div class="page-header">
                <h4 class="page-title">Absensi Guru P3K</h4>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mt-2">
                                    <a href="" onclick="this.href='/filter-p3k/'+ document.getElementById('tglawal').value +
                                    '/' + document.getElementById('tglakhir').value " class="btn btn-info">Lihat <i class="fas fa-print"></i></a>
                                    <a href="/cetak-p3k/{{ $data1 }}/{{ $data2 }}" class="btn btn-danger">Cetak PDF <i class="fas fa-file-pdf"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
