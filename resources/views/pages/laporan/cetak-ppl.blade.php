...
{{--            </div>--}}
{{--            <div class="col-md-6">--}}
{{--                <h3 class="text-center">PPLSP UNIVERSITAS PENDIDIKAN INDONESIA</h3>--}}
{{--                <h4 class="text-center">SMKN 1 CIMAHI</h4>--}}
{{--                <h5 class="text-center">Jl. Mahar Martanegara No.48, Utama, Kec. Cimahi Sel., Kota Cimahi, Jawa Barat 40521</h5>--}}
{{--            </div>--}}
{{--            <div class="col-md-2">--}}
{{--                <div class="text-center">--}}
{{--                    <img src="{{ asset('/assets/img/tutwuri.png')}}" style="width:120px; height:120px;">--}}
...
{{--        <hr>--}}
        <br>
        <h2 class="text-center">LAPORAN ABSENSI</h2>
        <h3 class="text-center">GURU PPLSP</h3>
