...
@section('title', 'Laporan Absensi Guru PPLSP')
    ...
    <div class="content">
        <div class="page-inner">
            <div class="page-header">
                <h4 class="page-title">Laporan Absensi Guru PPLSP</h4>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-12 mt-2">
                                    ...
                                    <a href="/cetak-ppl/{{ $data1 }}/{{ $data2 }}" class="btn btn-danger">Cetak PDF <i class="fas fa-file-pdf"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
